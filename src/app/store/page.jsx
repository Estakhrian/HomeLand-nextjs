    ...
    return (
        <div className="w-full p-3 flex flex-col items-center gap-5">
            ...
            <div className="relative bg-[#fcfcfc] mb-2 dark:bg-[#1a1d23] rounded-2xl">
                ...
                <input className="bg-gray-200 text-black/50 placeholder:text-black/40 dark:placeholder:text-gray-300 dark:bg-gray-600 w-56 rounded-2xl  pr-7 py-1 text-sm dark:text-gray-300"
                value={searchTerm}
