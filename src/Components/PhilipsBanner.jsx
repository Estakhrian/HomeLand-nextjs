    ...
    return (
        <div className="w-full">
         ...
         rounded-3xl overflow-hidden">
                ...
                <h2 className="absolute sm:right-4 md:right-12 lg:right-16 top-46 sm:top-18 lg:top-28 text-white text-3xl md:text-4xl font-bold">
                    محصولات برند فیلیپس
                </h2>

                <p className="absolute sm:right-4 md:right-12 lg:right-16 top-58 sm:top-36 lg:top-48 text-white text-base md:text-lg">
                    زندگی آسوده تر با محصولات هوشمند فیلیپس
                </p>

                <Link href={"/store"}>
                    <button className="absolute flex items-center justify-center gap-1 sm:right-4 md:right-12 lg:right-16
