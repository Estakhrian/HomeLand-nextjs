            ...
            <div>
                ...
                <div className="w-full flex flex-col md:flex-row justify-between items-stretch p-2 mt-14 mb-3">
                    ...
                    <div className="w-full md:w-30 flex flex-col items-start md:items-center gap-1 p-1">
                        <h2 className="text-sm font-medium mb-2 border-b border-gray-200 dark:text-gray-300">لینک های مهم</h2>
                    ...
                    <div className="w-full md:w-30 flex flex-col items-start md:items-center gap-1 p-1">
                        <h2 className="text-sm font-medium mb-2 border-b border-gray-200  dark:text-gray-300">دسته بندی </h2>
                        <ul className="flex flex-col items-center gap-1 text-sm text-gray-500">
                            <li>
                    ...
                    <div className="w-full md:w-30 flex flex-col items-start md:items-center gap-1 p-1">
                        <h2 className="text-sm font-medium mb-2 border-b border-gray-200  dark:text-gray-300">ارتباط با ما</h2>
                    ...
                    <div className="w-full md:w-30 flex flex-col items-start md:items-center gap-1 p-1">
                        <h2 className="text-sm font-medium mb-2 border-b border-gray-200  dark:text-gray-300"> نشان های اعتبار ما</h2>
